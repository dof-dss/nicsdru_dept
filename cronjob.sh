...
# Uncomment following line to ship drupal.log generated by Drupal filelog module.
/bin/bash /app/nicsdru-logging/scripts/shiplog.sh "drupal-dept" "/app/log/nigov/dept.log" "$(date +'%a, %d/%m/%Y -')" "drupal"
