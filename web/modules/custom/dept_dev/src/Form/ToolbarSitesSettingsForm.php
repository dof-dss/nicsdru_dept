...
class ToolbarSitesSettingsForm extends ConfigFormBase {
  ...
  public function getFormId() {
    return 'dept_devtools_settings_toolbar_sites';
  }
  ...
  protected function getEditableConfigNames() {
    return ['dept_devtools.settings.toolbar_sites'];
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['toolbar_sites']['lando_hostname'] = [
      ...
      '#default_value' => $this->config('dept_devtools.settings.toolbar_sites')->get('lando_hostname'),
    ];
    ...
    $form['toolbar_sites']['lando_protocol'] = [
      ...
      '#options' => ['HTTPS', 'HTTP'],
      '#default_value' => $this->config('dept_devtools.settings.toolbar_sites')->get('lando_protocol') ?? '0',
      '#states' => [
        'invisible' => [
